...
func getMovieDetail(_ movieId: Int) ->[String: Any]?{

    
    let semaphore = DispatchSemaphore (value: 0)

    var request = URLRequest(url: URL(string: "https://api.themoviedb.org/3/movie/\(movieId)?api_key=02308057abae9b91afa1f03630322904&language=en-US")!,timeoutInterval: Double.infinity)
    request.httpMethod = "GET"
